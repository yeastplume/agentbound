...
pub struct Session {
    pub lrd: String, pub allocation_id: String, pub authorization_id: String, pub scope_id: String, pub pidns_id: String, pub session_id: String, pub trace_id: String, pub topology: String,
...
impl Sessions {
    pub fn bind(&mut self, aid: &str, lrd: &str, az: &str, scope_id: &str, session_id: &str, trace_id: &str, uid: u32, gid: u32, domain_id: &str, topology: &str) {
        self.by_lrd.insert(lrd.into(), Session { lrd: lrd.into(), allocation_id: aid.into(), authorization_id: az.into(), scope_id: scope_id.into(), pidns_id: String::new(), session_id: session_id.into(), trace_id: trace_id.into(), topology: topology.into(),

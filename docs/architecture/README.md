...
| [ADR-0002](ADR-0002-gateway-authentication.md) gateway topology and authentication | 0.9 | **accepted for Phase 1**; reopened narrowly in WP1 (item 2 start-time check failed), amended, re-accepted; Decision 7 mechanism items 1–5 verified, component items 6–9 exercised in WP3, not yet verified (WP3.1 after independent review) | mechanism complete; one connection per process |

...
|---|---|---|---|
| [Phase 1 normative requirements](phase-1-requirements.md) | 0.7 | frozen (WP0) | complete; all questions answered |
...
| [ADR-0003](ADR-0003-control-substrate.md) control substrate | 0.7 | **accepted for Phase 1** | configuration, thresholds, confidence method, and classification rules filled; image digests recorded in `pinned-configuration.json` at image build; per-ID `control-arm-register.md` is a 1D prerequisite; two WP1 items (VM-1, VM-2) |

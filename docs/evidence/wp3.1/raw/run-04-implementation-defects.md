...
- Date: 2026-09-06T11:46:33Z
- Run id: run-79967884701357
- Repository commit: 207930e
- Binary digests (sha256/16): agentbound=8f38eaf5234c6012 agentbound-launch=c123b43b71924aee agentbound-lifecycle=10deec6098cfe905 agentbound-policy=f91c1b8281ee435d agentbound-audit=bcd332055de4bef9 agentbound-gateway=b97ae402bd69462f ab-conformance=342cd6ea3eca80ab ab-gwclient=9fd3112a050c0b9c probe.sh=1d2e1a8d592799a1 git-worker.sh=10cce5cae369d092
- Expected population: 121 catalogue ids (test-catalogue 1A+1B)
- Assertions: 136 PASS, 3 WEAK, 4 RECORDED, 0 FAIL (6 fixtures excluded)
- Catalogue coverage: 86 PASS, 2 WEAK, 4 RECORDED, 0 FAIL, **29 NOT-EXECUTED**
...
|---|---|---|
| D-01 | PASS | rc=0 lrd=sha256:2b4354035746da64b68a8dc280c77478097b1584471f9c0b56375e81c72213a6 {"allocation_id":"allocation:45ed3a21-00000646","console":"/var/lib/agentbound/sessions/45ed3a21-00000646/console.log","init_pid":439899,"launch_record_digest":"sha256:2b4354035746da64b68a8dc280c77478 |
...
| T-6.2-007.workspace | PASS | workspace writable as 200000 |
...
| T-6.9-004.bytes | PASS | /tmp tmpfs capacity=262144KiB; write stopped at 264155136 bytes: SIGKILL by memory cgroup (tmpfs pages charged to memory.max; disk bound not reached first) |
| T-6.9-004.inodes | PASS | nr_inodes=65536; creation refused after 65529 files, IFree=0 |
...
| PROBE-COMPLETE | FIXTURE | probe lines=33 |
| D-01.status | PASS | {"identity_state":"in-use","observation_seq":3,"reason":null,"record_ref":"sha256:2b4354035746da64b68a8dc280c77478097b1584471f9c0b56375e81c72213a6","state":"active"} |
...
| D-04.host-view | PASS | uid 200000 processes outside scope=0 |
| D-08 | PASS | {"cgroup_kill_written":true,"cgroup_procs_remaining":[],"credential_scan_inside_scope":[],"credential_scan_outside_scope":[],"d_state":[],"elapsed_ms":2030,"freeze_written":true,"frozen_observed":false,"gateway_admission_denied":false,"init_pid":439899,"init_pidfd_exited":true,"sigterm_sent":true} |
| F-T-03 | PASS | {"cgroup_kill_written":true,"cgroup_procs_remaining":[],"credential_scan_inside_scope":[],"credential_scan_outside_scope":[],"d_state":[],"elapsed_ms":2030,"freeze_written":true,"frozen_observed":false,"gateway_admission_denied":false,"init_pid":439899,"init_pidfd_exited":true,"sigterm_sent":true} |
...
| F-T-10 | PASS | {"identity_state":"quarantined","observation_seq":6,"reason":"conformance","record_ref":"sha256:2b4354035746da64b68a8dc280c77478097b1584471f9c0b56375e81c72213a6","state":"cleaned/sealed"} |
...
| T-6.6-001.audit | PASS | session.rejected events with failed_input=731 |
...
| F-C-09.record | PASS | lrd=sha256:26d76a1793d29e8cb7b4d493ccf07bc4310f7944bb95967a5a801583736c2866 kinds=["session.launch_record_committed", "session.construction_failed", "session.ownership_projected", "session.cleanup_completed", "session.identity_released", "session.sealed"] |
...
| T-6.5-009 | PASS | allocator latest states: [('free', 104), ('quarantined', 545), ('reclaiming', 1)]; free-before-floor violations=0 |
| T-6.8-setup | FIXTURE | sha256:6e92b426ec3678867fa12f75cf8df831c185f233082c5b2b1b25f30995b14dd6 |
...
| T-6.9-007 | PASS | audit chain head=sha256:8a38c7be3269fc19ebd83c8d0e7e5f062eb36f867f90fe5f3006f09595ddbc75 seq=21564 lost=0 |
| T-6.5-003 | PASS | rule=mount_source_escape detail=../../../etc errno=18 |
| D-10.launch | PASS | rc=0 lrd=sha256:96e820fe3617ac5ace6fe838e9d31e908315e1f3cf712a83734d3108a8830e77 topology=local-socket |
...
| D-10.bundle | FIXTURE | tip=829e55fe2912d052b5060297f01500b165f34b96 bytes=301 |
...
| T-6.3-003 | PASS | fds: 0 /dev/null 1 pipe:[253495] 2 pipe:[253495]  |
...
| D-13 | PASS | staging ref for session 256cee0f75fd2d20: true; main d5552a130bbe2bcd1eb2874644bb26717bd265b8→d5552a130bbe2bcd1eb2874644bb26717bd265b8 |
| D-13.trace | PASS | host hook log carries trace trace:a1d4a8af870c098900d47714dba43767 |
...
| T-6.4-003.only | PASS | exactly one socket node in /run: srw-rw-rw-    1 994      1000             0 Sep  6 11:44 /run/gateway.sock 1  |
...
| T-6.4-013 | PASS | caller-supplied session/trace refused (closed argument set); no ref under the other session's namespace: {"body":{"authorization_id":"launchrec:fix-issue-1235-000706","detail":"Unexpected(0, \"non-canonical\")","launch_record_digest":"sha256:29d979790d9f35b52778be47f948d8220ac2360d14adae0122fc340e5576fbba","requirement_id":"R-GW-1","rule":"parse","trace_id":"trace:d6aed854787a064d8822027b1d9b8066"},"cl |
| D4.7-reconstruct | PASS | socket before restart=1; chained reconstruction events 65→66 (exactly one for this restart); event: "projections":1 "stale_descriptors_dropped":0; ping from an in-scope session peer after restart: {"body":{"operation_seq":47,"result":{"pong":true},"trace_id":"trace:d6aed854787a064d8822027b1d9b8066"},"class":"ok","ok":true,"v":"agentbound.wire.v0.1"}  |
| T-6.9-005.budget-persist | PASS | 5 pings admitted (session op_count 47->52); lifecycle budget record then held op:gateway-ping operations=43 [{"op:gateway-ping":{"bytes":0,"operations":43},"op:git-push-staging":{"bytes":2727,"operations":9}}]; gateway restarted: session op_count restored to 52 (not reset); then 21 more pings admitted and 49 refused budget_operations (gateway.operation_denied events for this allocation); stored op:gateway-ping operations=64 == budget 64, and 43+21=64 |
| T-6.4-009 | PASS | PID reuse construction succeeded: establishing pid 409 was recycled inside the session pidns [stat: cannot statx '/proc/409/ns/pid': No such file or directory recycled_pid 40] with the same pid, uid and scope cgroup. Outcome: the connection was closed on establisher exit (113 connection_closed events for this allocation) and NO operation was admitted for the establishing pid afterwards (holder ops=0); process_mismatch denials 4->4 ; last gateway events for this allocation after the holder was triggered: "rule":"budget_operations" "reason":"peer_closed" "reason":"peer_exited" . The gateway's peer-pidfd poll closes the connection before a recycled instance can present itself, so the packet-level inode comparison is not reached live; that branch is covered deterministically by the unit test session::tests::recycled_pid_rejected |
| T-6.4-012 | WEAK | caller-supplied url ignored; bundle path enforced: rule":"args_schema"}  |
| D7-9.diagnostics | PASS | requirement=R-GW-4 authorization=launchrec:fix-issue-1235-000706 lrd-matches=true trace=trace:d6aed854787a064d8822027b1d9b8066 foreign-ids-absent=true |
| D7-8.audit-loss | PASS | gateway with no audit path (receiver down, spool unwritable): first op's event lost → admission closed + revocation_signal; lifecycle "trigger":"audit_pipeline_degraded_below_stop_threshold" → state=terminated; second attempt: nsenter: cannot open /proc/506495/ns/net: No such file or directory |
| D-06.storage-principal | PASS | work dir owner after seal: storage-engineering agentbound; files still owned by ephemeral uid: 0; "detail":{"bytes":1079,"failed":0,"files":26,"storage_principal":"storage:engineering-agent"} |
